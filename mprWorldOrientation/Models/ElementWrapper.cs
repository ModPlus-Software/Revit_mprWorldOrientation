namespace mprWorldOrientation.Models
{
    ...
    {
        private double RayLength = 1000d.MmToFt();
        private Lazy<List<Line>> _lines;
        ...
        /// </summary>
        public bool IsConturElement => HasFirstVectorIntersectedRoom != HasSecondVectorIntersectionRoom;
        ...
        private List<Line> GetRayVectors(Element element)
        {
            ...
            switch (element)
            {
                case Wall glassWall:
                {
                        ...
                        secondLine = Line.CreateBound(centralPointUp, centralPointUp + (secondDir * RayLength));
                        break;
                }
